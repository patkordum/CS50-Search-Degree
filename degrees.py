...
def shortest_path(source, target):
    ...
    Example:
        Demi Moore (193) -- in a few good man 104257 with 
        Tom Cruise (129) -- in rain man with 95953 with
        Dustin Hoffman (163)
        Function should return: [('104257', '129'), ('95953', '163')]
    '''
    ...
    while True: 
        ...
        # if a node is the goal, we are finished
        if node.state[1]==goal.state:  
            # backtrack the way to the start node and add tuples to path         
            path=[]
